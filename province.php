...
if (isset($_GET['item'])) {
    ...
    $slug = preg_replace('/^sexdate-/', '', $slug);
    if ($info['suffix']) {
...
<div class="container">
    ...
    <div class="row" id="oproepjes-list" v-cloak>
        ...
        <script>
            window.addEventListener('load', function(){
                createOproepjes('#oproepjes-list', "<?= api_base($country); ?>/profile/province_age/<?= $country; ?>/<?= rawurlencode($province['name']); ?>/45/99/120/S");
            });
        </script>
        <!-- Pagination -->
    ...
    <div class="container">
        ...
        <div class="jumbotron text-center">
            ...
            <a href="https://shemaledaten.net/shemale-<?php echo $province['img']; ?>" class="btn btn-primary prov-btn" target="_blank">Shemale sexdate <?php echo $province['name']; ?></a>
        </div>
    </div>
</div> <!-- container -->
<?php
